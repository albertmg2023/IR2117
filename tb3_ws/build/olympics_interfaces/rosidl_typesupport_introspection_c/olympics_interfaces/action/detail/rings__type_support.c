...
#include <stddef.h>
#include "olympics_interfaces/action/detail/rings__rosidl_typesupport_introspection_c.h"
#include "olympics_interfaces/msg/rosidl_typesupport_introspection_c__visibility_control.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  olympics_interfaces__action__Rings_Goal__init(message_memory);
}

void Rings_Goal__rosidl_typesupport_introspection_c__Rings_Goal_fini_function(void * message_memory)
{
  olympics_interfaces__action__Rings_Goal__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_Goal__rosidl_typesupport_introspection_c__Rings_Goal_message_member_array[1] = {
  {
    ...
    offsetof(olympics_interfaces__action__Rings_Goal, radius),  // bytes offset in struct
    NULL,  // default value
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_Goal__rosidl_typesupport_introspection_c__Rings_Goal_message_members = {
  "olympics_interfaces__action",  // message namespace
  "Rings_Goal",  // message name
  1,  // number of fields
  sizeof(olympics_interfaces__action__Rings_Goal),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_Goal)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  olympics_interfaces__action__Rings_Result__init(message_memory);
}

void Rings_Result__rosidl_typesupport_introspection_c__Rings_Result_fini_function(void * message_memory)
{
  olympics_interfaces__action__Rings_Result__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_Result__rosidl_typesupport_introspection_c__Rings_Result_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_Result, rings_completed),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_Result__rosidl_typesupport_introspection_c__Rings_Result_message_members = {
  ...
  1,  // number of fields
  sizeof(olympics_interfaces__action__Rings_Result),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_Result)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  olympics_interfaces__action__Rings_Feedback__init(message_memory);
}

void Rings_Feedback__rosidl_typesupport_introspection_c__Rings_Feedback_fini_function(void * message_memory)
{
  olympics_interfaces__action__Rings_Feedback__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_Feedback__rosidl_typesupport_introspection_c__Rings_Feedback_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_Feedback, drawing_ring),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_Feedback, ring_angle),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_Feedback__rosidl_typesupport_introspection_c__Rings_Feedback_message_members = {
  ...
  2,  // number of fields
  sizeof(olympics_interfaces__action__Rings_Feedback),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_Feedback)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  olympics_interfaces__action__Rings_SendGoal_Request__init(message_memory);
}
...
{
  olympics_interfaces__action__Rings_SendGoal_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_SendGoal_Request__rosidl_typesupport_introspection_c__Rings_SendGoal_Request_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_SendGoal_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_SendGoal_Request, goal),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_SendGoal_Request__rosidl_typesupport_introspection_c__Rings_SendGoal_Request_message_members = {
  ...
  2,  // number of fields
  sizeof(olympics_interfaces__action__Rings_SendGoal_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_SendGoal_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  olympics_interfaces__action__Rings_SendGoal_Response__init(message_memory);
}
...
{
  olympics_interfaces__action__Rings_SendGoal_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_SendGoal_Response__rosidl_typesupport_introspection_c__Rings_SendGoal_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_SendGoal_Response, accepted),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_SendGoal_Response, stamp),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_SendGoal_Response__rosidl_typesupport_introspection_c__Rings_SendGoal_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(olympics_interfaces__action__Rings_SendGoal_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_SendGoal_Response)() {
...
static rosidl_typesupport_introspection_c__ServiceMembers olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_service_members = {
  "olympics_interfaces__action",  // service namespace
  "Rings_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_service_type_support_handle = {
  0,
  &olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_SendGoal)() {
  if (!olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_service_type_support_handle.typesupport_identifier) {
    olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_SendGoal_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_SendGoal_Response)()->data;
  }

  return &olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_SendGoal_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  olympics_interfaces__action__Rings_GetResult_Request__init(message_memory);
}
...
{
  olympics_interfaces__action__Rings_GetResult_Request__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_GetResult_Request__rosidl_typesupport_introspection_c__Rings_GetResult_Request_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_GetResult_Request, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_GetResult_Request__rosidl_typesupport_introspection_c__Rings_GetResult_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(olympics_interfaces__action__Rings_GetResult_Request),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_GetResult_Request)() {
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  olympics_interfaces__action__Rings_GetResult_Response__init(message_memory);
}
...
{
  olympics_interfaces__action__Rings_GetResult_Response__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_GetResult_Response__rosidl_typesupport_introspection_c__Rings_GetResult_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_GetResult_Response, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_GetResult_Response, result),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_GetResult_Response__rosidl_typesupport_introspection_c__Rings_GetResult_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(olympics_interfaces__action__Rings_GetResult_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_GetResult_Response)() {
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_service_members = {
  "olympics_interfaces__action",  // service namespace
  "Rings_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_service_type_support_handle = {
  0,
  &olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_GetResult)() {
  if (!olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_service_type_support_handle.typesupport_identifier) {
    olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_service_type_support_handle.data;

  if (!service_members->request_members_) {
    service_members->request_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_GetResult_Request)()->data;
  }
  if (!service_members->response_members_) {
    service_members->response_members_ =
      (const rosidl_typesupport_introspection_c__MessageMembers *)
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_GetResult_Response)()->data;
  }

  return &olympics_interfaces__action__detail__rings__rosidl_typesupport_introspection_c__Rings_GetResult_service_type_support_handle;
}
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  // see https://github.com/ros2/ros2/issues/397
  (void) _init;
  olympics_interfaces__action__Rings_FeedbackMessage__init(message_memory);
}

void Rings_FeedbackMessage__rosidl_typesupport_introspection_c__Rings_FeedbackMessage_fini_function(void * message_memory)
{
  olympics_interfaces__action__Rings_FeedbackMessage__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember Rings_FeedbackMessage__rosidl_typesupport_introspection_c__Rings_FeedbackMessage_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_FeedbackMessage, goal_id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(olympics_interfaces__action__Rings_FeedbackMessage, feedback),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers Rings_FeedbackMessage__rosidl_typesupport_introspection_c__Rings_FeedbackMessage_message_members = {
  ...
  2,  // number of fields
  sizeof(olympics_interfaces__action__Rings_FeedbackMessage),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_olympics_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, olympics_interfaces, action, Rings_FeedbackMessage)() {
