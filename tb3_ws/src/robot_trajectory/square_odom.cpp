...
void topic_callback(const nav_msgs::msg::Odometry::SharedPtr m){
	...
	std::cout<<"x: "<<m->pose.pose.position.x<<std::endl;
	std::cout<<"y: "<<m->pose.pose.position.y<<std::endl;
	std::cout<<"z: "<<m->pose.pose.position.z<<std::endl;
	std::cout<<"orientation"<<std::endl;
	std::cout<<"x: "<<m->pose.pose.orientation.x<<std::endl;
	std::cout<<"y: "<<m->pose.pose.orientation.y<<std::endl;
	std::cout<<"z: "<<m->pose.pose.orientation.z<<std::endl;
